...
<div id="return-lost-item-wrapper" class="card">
<div class="card-head">
     <h4 class="text-center">Return Lost Item</h4>
</div>
<div class="card-body">
   <form>
           ...
           <table class="table table-bordered table-stripped">
               ...
               <tbody>
                 <tr>
                   ...
                   <td>2</td>
                   <td>
                       <button class="return-btn btn btn-primary">Edit</button>
                   </td> 
                 </tr>
               </tbody>       
           </table>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form>
              <div class="form-group">
                 <h4 class="text-center">Lost Amount : <label id="borrowedAmount">3</label>  
                 </h4>
